...
const RAW = [
  ...
  { c: "EN-001-026", s: "Programming", t: "การเขียนโปรแกรมพื้นฐานสำหรับปัญญาประดิษฐ์", e: "Foundational Programming for Artificial Intelligence", cr: "3(2-2-6)", g: "eng", y: 1, sem: 1, p: [1, 2, 6], ctx: "eng",
  ...
  { c: "EN-001-029", s: "Workshop II", t: "ปฏิบัติการวิศวกรรมเชิงบูรณาการ II", e: "Integrated Engineering Workshop II", cr: "1(0-3-1)", g: "eng", y: 1, sem: 2, p: [2, 5], h: ["EN-001-028"], co: ["EN-001-027"],
  ...
  { c: "EN-001-030", s: "Workshop III", t: "ปฏิบัติการวิศวกรรมเชิงบูรณาการ III", e: "Integrated Engineering Workshop III", cr: "1(0-3-1)", g: "eng", y: 2, sem: 3, p: [1, 2, 5], h: ["EN-001-029"], w: ["EN-001-027"],
  ...
  { c: "EN-131-104", s: "IoT/Edge", t: "ระบบอินเทอร์เน็ตของสรรพสิ่งอัจฉริยะและการประมวลผลที่ขอบเครือข่าย", e: "Smart Internet of Things and Edge Computing", cr: "3(2-2-5)", g: "ai", y: 2, sem: 3, p: [1, 2, 4], ctx: "ai", h: ["EN-001-027"], w: ["EN-001-026"],
  ...
  { c: "EN-134-104", s: "Capstone", t: "โครงงานวิศวกรรมปัญญาประดิษฐ์เเละระบบอัจฉริยะ", e: "Artificial Intelligence Engineering and Intelligent Systems Project", cr: "3(1-6-4)", g: "proj", y: 4, sem: 7, p: [1, 2, 3, 4, 5, 6, 7], h: ["EN-134-103"],
  ...
  eng: {
    ...
    items: [
      { name: "พื้นฐานทางวิศวกรรม", sub: "เศรษฐศาสตร์วิศวกรรม · สถิติ · ความร้อนและของไหล · เขียนแบบ · กลศาสตร์วัสดุ · การเขียนโปรแกรม · ไฟฟ้าและอิเล็กทรอนิกส์",
        codes: ["EN-001-021", "EN-001-022", "EN-001-023", "EN-001-024", "EN-001-025", "EN-001-026", "EN-001-027"] },
      { name: "ปฏิบัติการเชิงบูรณาการ", sub: "ชุดปฏิบัติการต่อเนื่อง I → II → III สร้างชิ้นงานเดียวกันจนเป็นระบบสมบูรณ์",
        codes: ["EN-001-028", "EN-001-029", "EN-001-030"] }
    ]
  },
...
export const CAREERS = [
  ...
  { id: "C04", track: 2, st: "M", th: "วิศวกรระบบควบคุมและอัตโนมัติ", en: "Automation and Control Engineer",
    courses: ["EN-001-027", "EN-001-030", "EN-132-106", "EN-135-116"],
  ...
  { id: "C05", track: 2, st: "M", th: "วิศวกรหุ่นยนต์และบูรณาการระบบ", en: "Robotics and System Integration Engineer",
    courses: ["EN-001-030", "EN-132-106", "EN-135-127", "EN-135-126", "EN-135-118", "EN-134-104"],
