...
const RAW = [
  ...
  /* ========= 2.4 เลือกชีพ — แขนงที่ 3 นวัตกรรมและซอฟต์แวร์ AI (EN-135-131..145) ========= */
...
export const COURSES = RAW.map(c => ({
  ...c,
  dEn: c.dEn || boiler(c.e, CTX[c.ctx || (c.tr ? `e${c.tr}` : c.g)] || CTX.eng)
}));
...
export const STRUCTURE = [
  ...
  { id: "ai", no: "2.2", name: "กลุ่มวิชาชีพหลักด้านปัญญาประดิษฐ์", code: "EN-131", credits: 24, n: 8, g: "ai",
    note: "แกน AI บังคับทุกแขนง 8 วิชา" },
  { id: "track", no: "2.3", name: "กลุ่มวิชาบังคับตามแขนงวิชา", code: "EN-132", credits: 24, n: 8, g: "track",
    note: "วิชาบูรณาการโดเมนที่ทุกแขนงเรียนร่วมกัน" },
  { id: "elec", no: "2.4", name: "กลุ่มวิชาเลือกเฉพาะแขนงวิชา", code: "EN-135-1xx", credits: 15, n: 5, g: "elec",
    note: "เลือก 5 วิชาจาก pool 45 วิชา (3 แขนง × 15)" },
  { id: "proj", no: "2.6", name: "กลุ่มวิชาโครงงานและสัมมนา", code: "EN-134", credits: 6, n: 4, g: "proj",
    note: "สัมมนา I–II · เตรียมโครงงาน · โครงงาน (Capstone)" },
  { id: "field", no: "2.7", name: "กลุ่มวิชาฝึกประสบการณ์ภาคสนาม", code: "EN-135-4xx", credits: 7, n: 2, g: "field",
...
export const YLO_DETAIL = {
  ...
  3: { title: "การบูรณาการระบบตามโดเมนและแขนงวิชา", en: "Domain Integration and Track Practice",
    ...
    text: "เมื่อสิ้นสุดชั้นปีที่ 3 นักศึกษาสามารถวิเคราะห์ ออกแบบ และบูรณาการระบบปัญญาประดิษฐ์หรือระบบอัจฉริยะประยุกต์สำหรับบริบทเฉพาะทาง อาทิ เกษตรกรรม อุตสาหกรรม หรือนวัตกรรมซอฟต์แวร์ โดยสามารถวิเคราะห์ข้อกำหนด ความต้องการ และข้อจำกัด เลือกสรรเทคโนโลยีที่เหมาะสม ประเมินผลสัมฤทธิ์ของการดำเนินงาน ปฏิบัติงานร่วมกับทีมสหวิทยาการ สื่อสารข้อมูลเชิงเทคนิคกับผู้มีส่วนได้ส่วนเสีย ตลอดจนบูรณาการมิติด้านความเป็นไปได้ทางธุรกิจ จริยธรรมวิชาชีพ ความปลอดภัย และการพัฒนาอย่างยั่งยืนเข้าสู่กระบวนการตัดสินใจทางวิศวกรรม",
...
export const TRACK_NAME = {
  ...
  3: "แขนง 3 · นวัตกรรมซอฟต์แวร์ปัญญาประดิษฐ์", 0: "อาชีพข้ามทุกแขนงวิชา"
};
