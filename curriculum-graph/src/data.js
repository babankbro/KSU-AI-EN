...
const RAW = [
  ...
  { c: "EN-135-336", s: "AI Reliability/Safety", t: "ความน่าเชื่อถือและความปลอดภัยของปัญญาประดิษฐ์", e: "AI Reliability and Safety", cr: "3(2-2-5)", g: "elec", tr: 3, p: [2, 4, 6], h: ["EN-132-305"], w: ["EN-131-207"],
  ...
  { c: "EN-135-337", s: "Enterprise AI Arch", t: "สถาปัตยกรรมปัญญาประดิษฐ์ระดับองค์กร", e: "Enterprise AI Architecture", cr: "3(2-2-5)", g: "elec", tr: 3, p: [2, 4, 7], h: ["EN-132-305"], w: ["EN-131-207"],
  ...
  { c: "EN-135-346", s: "AI Product Mgmt", t: "การจัดการผลิตภัณฑ์ปัญญาประดิษฐ์", e: "AI Product Management", cr: "3(2-2-5)", g: "elec", tr: 3, p: [2, 3, 5, 7], h: ["EN-132-201"], w: ["EN-132-305"],
  ...
  { c: "EN-135-348", s: "AI Governance/Risk", t: "ธรรมาภิบาลและความเสี่ยงของปัญญาประดิษฐ์", e: "AI Governance and Risk", cr: "3(2-2-5)", g: "elec", tr: 3, p: [3, 4, 7], h: ["EN-131-207"], w: ["EN-132-305"],
...
export const CAREERS = [
  { id: "C01", track: 3, st: "M", th: "วิศวกรปัญญาประดิษฐ์และการเรียนรู้ของเครื่อง", en: "AI/ML Engineer",
    courses: ["EN-131-203", "EN-131-207", "EN-132-305", "EN-135-335", "EN-135-336", "EN-134-403"],
  ...
  { id: "C02", track: 0, st: "M", th: "วิศวกรประยุกต์และโซลูชันปัญญาประดิษฐ์", en: "AI Application / Solutions Engineer",
    courses: ["EN-132-201", "EN-132-305", "EN-132-306", "EN-135-337", "EN-134-403", "EN-135-402"],
  ...
  { id: "C06", track: 3, st: "M", th: "วิศวกรซอฟต์แวร์และแอปพลิเคชันปัญญาประดิษฐ์", en: "AI Software and Application Engineer",
    courses: ["EN-132-305", "EN-132-306", "EN-135-335", "EN-135-336", "EN-135-337", "EN-134-403"],
  ...
  { id: "C08", track: 3, st: "F", th: "นักออกแบบและสร้างนวัตกรรมด้านปัญญาประดิษฐ์", en: "AI Innovator",
    courses: ["EN-132-201", "EN-132-305", "EN-135-338", "EN-135-343", "EN-135-346", "EN-134-403"],
  ...
  { id: "C14", track: 2, st: "M", th: "วิศวกรปัญญาประดิษฐ์ด้านกระบวนการและการผลิต", en: "AI Process and Production Engineer",
    courses: ["EN-001-126", "EN-001-125", "EN-132-304", "EN-135-316", "EN-135-334", "EN-134-403"],
  ...
  { id: "C16", track: 2, st: "M", th: "วิศวกรซ่อมบำรุงด้วยปัญญาประดิษฐ์", en: "AI Maintenance Engineer",
    courses: ["EN-001-125", "EN-132-304", "EN-135-316", "EN-135-326", "EN-135-334", "EN-134-403"],
  ...
  { id: "C22", track: 0, st: "M", th: "วิศวกรโครงการและติดตั้งระบบอัจฉริยะ", en: "Intelligent Systems Project and Implementation Engineer",
    courses: ["EN-132-201", "EN-132-305", "EN-135-344", "EN-134-302", "EN-134-403", "EN-135-402"],
  ...
  { id: "C23", track: 0, st: "M", th: "วิศวกรบูรณาการระบบอัจฉริยะ", en: "Intelligent Systems Integration Engineer",
    courses: ["EN-001-230", "EN-132-305", "EN-131-205", "EN-135-336", "EN-135-337", "EN-134-403"],
  ...
  { id: "C26", track: 3, st: "F", th: "นักวิเคราะห์ผลิตภัณฑ์และผู้ประสานงานโครงการปัญญาประดิษฐ์", en: "AI Product and Project Analyst",
    courses: ["EN-132-201", "EN-132-305", "EN-135-338", "EN-135-344", "EN-135-346", "EN-134-403"],
