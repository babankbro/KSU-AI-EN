  ...
  return (
    <main>
      <PageHead
        ...
        title="โครงสร้างหลักสูตร 133 หน่วยกิต"
        lead="โครงสร้างประกอบด้วย Core Track 9 วิชา 27 หน่วยกิต และวิชาเลือกชีพ 5 วิชา 15 หน่วยกิต รวมทั้งหลักสูตร 133 หน่วยกิต ซึ่งเป็นยอดที่ยืนยันแล้ว"
      ...
      <div className="wrap">
        ...
        <div className="note">
          หมวดวิชาเฉพาะรวม <b>103 หน่วยกิต</b> = พื้นฐานและปฏิบัติการวิศวกรรม 24 + แกน AI 24 + Core Track 27 +
          เลือกชีพ 15 + โครงงานและสัมมนา 6 + ฝึกประสบการณ์ 7 · เมื่อรวมศึกษาทั่วไป 24 และเลือกเสรี 6
          จึงได้ <b>{TOTAL_CREDITS} หน่วยกิต</b> ซึ่งเป็นยอดที่ยืนยันแล้ว โดยวาง EN-132-201 ในภาค 4
          และ EN-135-401 เตรียมความพร้อมสหกิจศึกษาในภาค 6 ของแผนการเรียน
        </div>
