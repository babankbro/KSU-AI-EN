    ...
    <main className="obe">
      ...
      <div className="wrap">
        ...
        <Section id="skill" title="④ ทักษะเป้าหมายและฐานวิศวกรรม (HS1–HS20 · SS1–SS10 · EF1–EF6)" sub="ทักษะอาชีพ Hard/Soft เชื่อมกับฐานวิศวกรรมที่ผู้ทรงคุณวุฒิกำหนด">
          ...
          <p className="obe-note">ระดับที่แสดงคือ<b>ระดับปลายทางเมื่อสำเร็จการศึกษา</b> ไม่ใช่ระดับที่ทุกรายวิชาต้องตอบ — รหัสทักษะเดียวกันไล่ระดับขึ้นตามชั้นปีที่รายวิชานั้นเปิดสอน · CLO ในแต่ละรายวิชาไล่ระดับจากต่ำไปสูงและใช้อย่างน้อยสองระดับ โดยเพดานคือ ปี 1 ถึงประยุกต์ใช้ · ปี 2 ถึงวิเคราะห์ · ปี 3–4 ถึงประเมินค่า</p>
