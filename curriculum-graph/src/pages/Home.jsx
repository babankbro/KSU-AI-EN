...
const CARDS = [
  { to: "/structure", icon: "▦", t: "โครงสร้างหลักสูตร", d: "133 หน่วยกิต แยกตามหมวดและกลุ่มวิชา กดเข้าดูรายวิชาในแต่ละกลุ่มได้" },
      ...
      <div className="hero">
        <div className="wrap">
          ...
          <div className="note">
            ...
            รวม 133 หน่วยกิต แผน 8 ภาคกระจายเป็น 19–19–19–19–19–17–15–6 หน่วยกิต
