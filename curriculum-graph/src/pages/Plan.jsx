  ...
  return (
    <main>
      <PageHead
        ...
        lead="แผนการเรียน 133 หน่วยกิต กระจายเป็น 38–38–36–21 หน่วยกิต ทุกภาคไม่น้อยกว่า 15 หน่วยกิต ยกเว้นภาค 8 ที่สงวนไว้ให้สหกิจศึกษาเต็มเวลา"
      ...
      <div className="wrap">
        ...
        <Section title="หลักการจัดลำดับและสมดุลภาระการเรียน" sub="วางพื้นฐานก่อนวิชาบูรณาการ และเก็บภาคสุดท้ายสำหรับสหกิจเต็มเวลา">
          <div className="note">
            ...
            ทุกภาคการศึกษาที่ 1–7 ไม่น้อยกว่า 15 หน่วยกิต
            (ภาค 1–5 ที่ 19 · ภาค 6 ที่ 17 · ภาค 7 ที่ 15) และภาค 8 สงวนไว้ให้สหกิจศึกษา 6 หน่วยกิต · GE กระจายจากภาษาอังกฤษ/อัตลักษณ์ในปี 1
            ...
            EN-135-401 เตรียมความพร้อมสหกิจศึกษาอยู่ภาค 6 เรียนคู่กับ EN-134-303 การเตรียมความพร้อมโครงงาน
            เพื่อให้ผู้เรียนได้รับการตอบรับจากสถานประกอบการก่อนเลือกวิชาชีพเลือกสองวิชาสุดท้ายในภาค 7 และใช้โจทย์เดียวกันกับโครงงาน
          </div>
        </Section>
