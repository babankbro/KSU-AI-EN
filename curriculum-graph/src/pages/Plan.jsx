  ...
  return (
    <main>
      <PageHead
        ...
        lead="แผนข้อเสนอ 133 หน่วยกิต กระจายเป็น 38–38–35–22 หน่วยกิต ทุกภาคไม่น้อยกว่า 15 หน่วยกิต ยกเว้นภาค 8 ที่สงวนไว้ให้สหกิจศึกษาเต็มเวลา"
      ...
      <div className="wrap">
        ...
        <Section title="หลักการจัดลำดับและสมดุลภาระการเรียน" sub="วางพื้นฐานก่อนวิชาบูรณาการ และเก็บภาคสุดท้ายสำหรับสหกิจเต็มเวลา">
          <div className="note">
            ...
            ยกเว้นวิชาชีพเลือกที่คงรหัส EN-133-3xx ทั้งกลุ่ม · ทุกภาคการศึกษาที่ 1–7 ไม่น้อยกว่า 15 หน่วยกิต
            (ภาค 1–5 ที่ 19 · ภาค 6–7 ที่ 16) และภาค 8 สงวนไว้ให้สหกิจศึกษา 6 หน่วยกิต · GE กระจายจากภาษาอังกฤษ/อัตลักษณ์ในปี 1
