    ...
    <main>
      ...
      <div className="wrap">
        ...
        <Section title="หลักการจัดลำดับและสมดุลภาระการเรียน" sub="วางพื้นฐานก่อนวิชาบูรณาการ และเก็บภาคสุดท้ายสำหรับสหกิจเต็มเวลา">
          <div className="note">
            GE กระจายจากภาษาอังกฤษ/อัตลักษณ์ในปี 1 ไปสู่การออกแบบชีวิต จริยธรรม–เศรษฐศาสตร์
            ธุรกิจดิจิทัล และภาวะผู้นำก่อนทำ Capstone · EN-132-201 วางในภาค 3 เพื่อเป็นฐานของระบบเกษตร
            ระบบอัตโนมัติ และการผลิตอัจฉริยะ · EN-135-401 ย้ายมาอยู่ภาค 6 เพื่อเตรียมสมัครและจับคู่สถานประกอบการล่วงหน้า
          </div>
        </Section>
