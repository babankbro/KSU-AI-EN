  ...
  return (
    <main>
      <PageHead
        ...
        lead="แผนข้อเสนอ 133 หน่วยกิต กระจายภาระปี 1–3 ใกล้เคียงกันที่ 38–37–37 หน่วยกิต และลดภาระปี 4 เป็น 15–6 หน่วยกิต เพื่อเน้นโครงงานและสหกิจศึกษา"
      ...
      <div className="wrap">
        ...
        <Section title="หลักการจัดลำดับและสมดุลภาระการเรียน" sub="วางพื้นฐานก่อนวิชาบูรณาการ และเก็บภาคสุดท้ายสำหรับสหกิจเต็มเวลา">
          <div className="note">
            ...
            ยกเว้นวิชาชีพเลือกที่คงรหัส EN-133-3xx ทั้งกลุ่ม · ทุกภาคการศึกษาที่ 1–6 ไม่น้อยกว่า 18 หน่วยกิต
            และลดภาระปี 4 เป็น 15 + 6 หน่วยกิต · GE กระจายจากภาษาอังกฤษ/อัตลักษณ์ในปี 1 ไปสู่การออกแบบชีวิต
            จริยธรรม–เศรษฐศาสตร์ ธุรกิจดิจิทัล และภาวะผู้นำ ให้ครบ 24 หน่วยกิตภายในสิ้นปี 2 ·
            ...
            EN-135-301 ย้ายมาอยู่ภาค 6 เพื่อเตรียมสมัครและจับคู่สถานประกอบการล่วงหน้า
          </div>
        </Section>
        ...
        <div className="note">
          ...
          <Link className="lnk" to="/courses/EN-135-301"> EN-135-301 เตรียมความพร้อมสหกิจศึกษา</Link> ก่อนออกปฏิบัติงาน
        </div>
