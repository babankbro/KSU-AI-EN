  ...
  return (
    <main>
      <PageHead
        ...
        lead="แผนข้อเสนอ 133 หน่วยกิต กระจายภาระปี 1–3 เท่ากันที่ 38 หน่วยกิตต่อปี (19 หน่วยกิตทุกภาค) และลดภาระปี 4 เป็น 13–6 หน่วยกิต เพื่อเน้นโครงงานและสหกิจศึกษา"
      ...
      <div className="wrap">
        <Section title="สรุปหน่วยกิตตามชั้นปี">
          <div className="yearbar">
            ...
            <div className="yb total"><b>{TOTAL_CREDITS}</b><span>รวมแผนข้อเสนอ</span><small>8 ภาคการศึกษา</small></div>
          </div>
        </Section>
        ...
        <Section title="หลักการจัดลำดับและสมดุลภาระการเรียน" sub="วางพื้นฐานก่อนวิชาบูรณาการ และเก็บภาคสุดท้ายสำหรับสหกิจเต็มเวลา">
          <div className="note">
            ...
            ยกเว้นวิชาชีพเลือกที่คงรหัส EN-133-3xx ทั้งกลุ่ม · ทุกภาคการศึกษาที่ 1–6 อยู่ที่ 19 หน่วยกิตเท่ากัน
            (ไม่น้อยกว่าเกณฑ์ 18 หน่วยกิต) และปี 4 เหลือ 13 + 6 หน่วยกิต · GE กระจายจากภาษาอังกฤษ/อัตลักษณ์ในปี 1
            ไปสู่การออกแบบชีวิต จริยธรรม–เศรษฐศาสตร์ ธุรกิจดิจิทัล และภาวะผู้นำ ให้ครบ 24 หน่วยกิตภายในสิ้นปี 2 ·
            EN-131-101 และ EN-131-102 วางในปี 1 เพื่อให้ EN-131-202 การเรียนรู้ของเครื่องในภาค 3 มีคณิตศาสตร์ครบเป็นวิชาก่อน
            แทนการเรียนคู่ขนาน · EN-132-201 วางในภาค 4 เพื่อเป็นฐานของระบบเกษตร ระบบอัตโนมัติ และการผลิตอัจฉริยะในปี 3 ·
            EN-134-201 สัมมนา I วางในภาค 4 และ EN-134-302 สัมมนา II ในภาค 5 เพื่อให้ผู้เรียนเริ่มฝึกสืบค้นและนำเสนอเชิงวิชาการตั้งแต่ปี 2 ·
            EN-135-401 เตรียมความพร้อมสหกิจศึกษาอยู่ภาค 7 ควบกับโครงงาน เพื่อจับคู่สถานประกอบการก่อนออกปฏิบัติงานในภาค 8
          </div>
        </Section>
        ...
        <div className="note">
          ...
          โครงงาน <Link className="lnk" to="/courses/EN-134-404">EN-134-404</Link> รวมทั้ง
