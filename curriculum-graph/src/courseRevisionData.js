...
export const COURSE_REVISION = {
  ...
  "EN-132-104": {
    ...
    "cr": "3(2-2-5)",
    "d": "ข้อกำกับ กฎหมาย ความปลอดภัย และจริยธรรมของระบบอัตโนมัติทางการเกษตร หลักการอากาศยานไร้คนขับ ระบบพิกัดดาวเทียมความแม่นยำสูง การวางแผนภารกิจและเส้นทางอัตโนมัติ การเก็บข้อมูลด้วยกล้องอาร์จีบี มัลติสเปกตรัม และเทอร์มอล การตรวจวัดระยะไกล การสร้างแผนที่และแบบจำลองสามมิติ ระบบภูมิสารสนเทศและปัญญาประดิษฐ์เชิงพื้นที่ หลักการหุ่นยนต์เคลื่อนที่และแขนกลทางการเกษตร การรับรู้ ตำแหน่ง การนำทาง การหลบหลีกสิ่งกีดขวาง การมองเห็นของเครื่องจักร การควบคุมตัวกระตุ้นและเครื่องมือปฏิบัติงาน การประเมินสุขภาพพืช การฉีดพ่นแม่นยำ การสำรวจและการเก็บเกี่ยว การเชื่อมข้อมูลอากาศยานและหุ่นยนต์กับระบบฟาร์ม การทดสอบภาคสนาม สมรรถนะ ความปลอดภัย และความรับผิดชอบต่อสิ่งแวดล้อม",
    "dEn": "Regulation, law, safety, and ethics of autonomous agricultural systems; principles of unmanned aerial vehicles; high-precision satellite positioning; autonomous mission and path planning; data acquisition with RGB, multispectral, and thermal cameras; remote sensing; mapping and three-dimensional modeling; geographic information systems and GeoAI; principles of agricultural mobile robots and manipulators; perception, localization, navigation, obstacle avoidance, machine vision, and control of actuators and implements; crop-health assessment, precision spraying, surveying, and harvesting; integration of UAV and robot data with farm systems; field testing of performance, safety, and environmental responsibility",
    "source": "04_Track_Core.md"
  },
  "EN-132-105": {
  ...
  "EN-135-130": {
    "t": "การจัดการพลังงานอัจฉริยะในโรงงานอุตสาหกรรม",
    "e": "Smart Energy Management in Industrial Plants",
    "cr": "3(2-2-5)",
    ...
    "dEn": "Principles of energy management and conservation in industry; auditing and assessing the energy use of machinery and support systems — air-conditioning, compressed-air, and boiler systems; integration of sensor networks and smart meters to collect real-time energy-use data; building energy-use models with AI; energy-demand forecasting and anomaly detection with machine learning; integration of renewable energy — solar and biomass — in the plant; design of smart energy-management systems to reduce cost and greenhouse-gas emissions",
    "source": "06_Electives_Industrial_AI.md"
  },
  "EN-135-131": {
