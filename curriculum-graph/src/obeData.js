...
export const HARD_SKILLS = [
  ...
  { id: "H2", name: "Programming & AI Software Engineering", core: true, set: "AISK01", rank: 2,
    track: { T1: "●", T2: "●", T3: "●" }, plo: [2, 1], courses: ["EN-001-106", "EN-132-304"],
  ...
  { id: "H3", name: "Data Engineering, Analytics & Visualization", core: true, set: "AISK01", rank: 3,
    track: { T1: "●", T2: "●", T3: "●" }, plo: [6, 2, 3], courses: ["EN-131-203", "EN-132-305"],
  ...
  { id: "H5", name: "Industrial Automation, Robotics & Digital Twin", core: true, set: "AISK03", rank: 5,
    track: { T1: "○", T2: "●", T3: "○" }, plo: [2, 1], courses: ["EN-132-303", "EN-132-307"],
  ...
  { id: "H6", name: "Generative AI, LLM & Agentic Systems", core: true, set: "AISK06", rank: 6,
    track: { T1: "○", T2: "○", T3: "●" }, plo: [2, 7], courses: ["EN-131-101", "EN-132-308"],
  ...
  { id: "H8", name: "Computer Vision, Remote Sensing & Multimodal AI", core: true, set: "AISK05", rank: 8,
    track: { T1: "●", T2: "●", T3: "○" }, plo: [2, 6], courses: ["EN-131-204", "EN-132-306"],
  ...
  { id: "H10", name: "NLP & Thai NLP / Sovereign AI", core: false, set: "AISK06", rank: 10,
    track: { T1: "○", T2: "○", T3: "●" }, plo: [2, 7], courses: ["EN-132-308"], link: "H6",
  ...
  { id: "H11", name: "Time-Series Forecasting & Predictive Analytics", core: false, set: "AISK05", rank: 11,
    track: { T1: "●", T2: "●", T3: "○" }, plo: [6, 2], courses: ["EN-132-305", "EN-132-302", "EN-132-307"], link: "H1, H3",
  ...
  { id: "H13", name: "Reinforcement Learning, Optimization & OR", core: false, set: "AISK03", rank: 13,
    track: { T1: "○", T2: "●", T3: "○" }, plo: [1, 2], courses: ["EN-132-305", "EN-132-303"], link: "H1, H5",
  ...
  { id: "H15", name: "Green / Sustainable AI & Model Efficiency", core: false, set: "AISK02", rank: 15,
    track: { T1: "●", T2: "○", T3: "○" }, plo: [4, 2], courses: ["EN-001-103", "EN-132-302"], link: "H4, H9",
  ...
  { id: "H16", name: "Smart Agriculture, Precision Agriculture & Agri-food Systems", core: false, set: "AISK02", rank: 16,
    track: { T1: "●", T2: "○", T3: "○" }, plo: [2,4,6], courses: ["EN-132-302","EN-132-306","EN-132-201"],
  ...
  { id: "H17", name: "Smart Manufacturing, Process, Production, Quality & MES", core: false, set: "AISK03", rank: 17,
    track: { T1: "○", T2: "●", T3: "○" }, plo: [2,4,6], courses: ["EN-132-307","EN-132-303"],
  ...
  { id: "H18", name: "Maintenance, Reliability & Asset Intelligence", core: false, set: "AISK03", rank: 18,
    track: { T1: "○", T2: "●", T3: "○" }, plo: [2,4,6], courses: ["EN-132-307","EN-132-201","EN-133-317"],
  ...
  { id: "H19", name: "Decision Intelligence, BI, DSS & Operations Analytics", core: false, set: "AISK05", rank: 19,
    track: { T1: "●", T2: "●", T3: "●" }, plo: [2,3,6], courses: ["EN-131-203","EN-132-305"],
  ...
  { id: "H20", name: "Enterprise Solution Architecture, Integration & Digital Services", core: false, set: "AISK09", rank: 20,
    track: { T1: "○", T2: "○", T3: "●" }, plo: [2,3,4,7], courses: ["EN-132-301","EN-132-304","EN-132-308"],
...
export const SOFT_SKILLS = [
  ...
  { id: "S5", name: "Teamwork, Cross-functional Collaboration & Leadership", core: true, set: "AISK08", rank: 5,
    track: { T1: "●", T2: "●", T3: "●" }, plo: [5], courses: ["EN-001-108", "EN-001-109", "EN-001-201", "EN-134-404"],
  ...
  { id: "S9", name: "Stakeholder, Requirements & Change Facilitation", core: false, set: "AISK09", rank: 9,
    track: { T1: "●", T2: "●", T3: "●" }, plo: [2,3,5,7], courses: ["EN-132-301","EN-132-304","EN-134-404"],
  ...
  { id: "S10", name: "Agile Delivery, Quality, Safety & Professional Accountability", core: false, set: "AISK09", rank: 10,
    track: { T1: "●", T2: "●", T3: "●" }, plo: [4,5,6], courses: ["EN-001-201","EN-132-307","EN-132-303","EN-132-304","EN-132-201"],
...
export const SKILL_SETS = [
  { id: "AISK01", g: "G1", type: "Hard",
    ...
    courses: ["EN-001-102","EN-001-106","EN-131-101","EN-131-102","EN-131-205","EN-131-202","EN-131-203","EN-131-206","EN-132-304"] },
  ...
  { id: "AISK02", g: "G2", type: "Hard",
    ...
    courses: ["EN-001-103","EN-001-104","EN-001-105","EN-001-108","EN-001-109","EN-001-201","EN-132-305","EN-132-302","EN-132-306","EN-132-201","EN-134-404"] },
  ...
  { id: "AISK03", g: "G2", type: "Hard",
    ...
    courses: ["EN-001-101","EN-001-103","EN-001-104","EN-001-105","EN-001-107","EN-001-201","EN-132-305","EN-132-307","EN-132-303","EN-132-201","EN-134-404"] },
  ...
  { id: "AISK04", g: "G3", type: "Hard",
    ...
    courses: ["EN-001-107","EN-001-109","EN-001-201","EN-131-201","EN-131-206","EN-132-302","EN-132-307","EN-132-303","EN-132-201"] },
  ...
  { id: "AISK05", g: "G3", type: "Hard",
    ...
    courses: ["EN-131-204","EN-131-203","EN-132-301","EN-132-305","EN-132-302","EN-132-306","EN-132-307","EN-134-404"] },
