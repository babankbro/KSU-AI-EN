...
/* ---------- ระดับ Bloom ----------
   ...
   เพดานชั้นปี: ปี 1 = B3 · ปี 2 = B4 · ปี 3–4 และวิชาเลือก = B5 */
const VERB_LEVEL = [
  ...
  ["ทำงาน",3],["เก็บ",3],["แสดง",3],["ทดสอบ",3],["ประมวลผล",3],["ตีความ",2],["วิเคราะห์",4],
  ["วินิจฉัย",4],["จำแนก",2],["เลือก",4],["ตรวจสอบ",4],["แปลง",3],["บูรณาการ",3],
  ["พยากรณ์",4],["ติดตาม",3],["กำหนด",4],["เปรียบเทียบ",4],["ออกแบบ",4],["ชี้บ่ง",4],
...
function bloomOf(code, n, text) {
  ...
  const ceiling = year === 1 ? 3 : (year === 2 ? 4 : 5);
