...
| รหัสและอาชีพ | พื้นฐานวิศวกรรม | แกน AI | แกนบูรณาการ/เฉพาะบริบท | วิชาเลือกแนะนำ | หลักฐานปลายทาง |
|---|---|---|---|---|---|
| **C01 วิศวกร AI/ML** | EN-001-126; EN-001-122 | EN-131-102 คณิตศาสตร์ AI; EN-131-203 ML/DL; EN-131-207 Cloud/MLOps; EN-131-204 Data Engineering | EN-132-305 Software & AI Engineering; EN-132-306 Agentic AI | EN-135-336; EN-135-337; EN-135-339 | End-to-end ML service พร้อม evaluation, API, deployment และ monitoring |
| **C06 วิศวกรซอฟต์แวร์และแอปพลิเคชัน AI** | EN-001-122 | EN-131-207 Cloud/MLOps; EN-131-204 Data Engineering | EN-132-305 Software & AI Engineering; EN-132-306 Agentic AI | EN-135-337 Advanced LLM; EN-135-338 AI Reliability/Safety; EN-135-339 Enterprise AI Architecture | AI application พร้อม evaluation, integration, security, reliability และ observability |
| **C07 วิศวกรข้อมูล** | EN-001-126; EN-001-122 | EN-131-204 Data Engineering; EN-131-207 Cloud/MLOps | EN-132-305 Software & AI Engineering | EN-135-336 Advanced Data Engineering; EN-135-339 Enterprise AI Architecture | ETL/ELT pipeline พร้อม data quality, lineage, orchestration และ enterprise integration |
| **C08 นักออกแบบและสร้างนวัตกรรม AI** | EN-001-227; EN-001-122 | EN-131-101 Intro AI; EN-131-203 ML/DL | EN-132-201 AI BI/Product; EN-132-305; EN-132-306 | EN-135-340 UX/UI; EN-135-345 AI Venture; EN-135-348 AI Product Management | Product discovery, prototype, experiment, adoption และ value/KPI validation |
| **C09 ผู้ประกอบการเทคโนโลยีและ AI** | EN-001-227; GE-020-008 ธุรกิจดิจิทัล | EN-131-101 Intro AI | EN-132-201 AI BI/Product; EN-132-202 Decision/Supply Chain | EN-135-345; EN-135-347; EN-135-348 | Problem–solution fit, prototype, business model และ go-to-market evidence |
| **C26 นักวิเคราะห์ผลิตภัณฑ์และผู้ประสานงานโครงการ AI** | EN-001-227; EN-001-122 | EN-131-101; EN-131-204 | EN-132-201 AI BI/Product; EN-132-305 Software & AI Engineering | EN-135-340 UX/UI; EN-135-346 Project Management; EN-135-348 AI Product Management | Product brief, roadmap, backlog, experiment, metrics, risk register และ delivery review |

## 7. อาชีพข้ามทุก Track

| รหัสและอาชีพ | พื้นฐานวิศวกรรม | แกน AI | แกนบูรณาการ | วิชาเลือกแนะนำ | หลักฐานปลายทาง |
|---|---|---|---|---|---|
| **C02 วิศวกรประยุกต์และโซลูชัน AI** | EN-001-122; EN-001-230 | EN-131-207; EN-131-204 | EN-132-201; EN-132-305; EN-132-306 | EN-135-338/334/341 หรือวิชาเลือกโดเมน | Requirement, architecture, prototype, integration และ acceptance test |
| **C10 นักวิจัย AI และระบบอัจฉริยะ** | EN-001-126; EN-001-122 | EN-131-102; EN-131-203 และแกน AI ตามหัวข้อ | Core Track ตามโดเมนวิจัย | วิชาเลือกเชิงลึกตามหัวข้อ | EN-134-301/302/303/404 พร้อมโจทย์วิจัย การทดลอง และผลที่ทำซ้ำได้ |
| **C11 นักเทคโนโลยีดิจิทัลภาครัฐ** | EN-001-227; EN-001-122 | EN-131-207; EN-131-208 | EN-132-201; EN-132-202; EN-132-305 | EN-135-350 AI Governance and Risk | Digital service พร้อม risk classification, governance, security, procurement และ service handover |
| **C12 นักวิทยาศาสตร์ข้อมูล/นักวิเคราะห์ข้อมูล** | EN-001-126; EN-001-122 | EN-131-102; EN-131-203; EN-131-204 | EN-132-202 Decision/Supply Chain | EN-135-319 Advanced OR; EN-135-336 | Data analysis/model/optimization พร้อมการตีความและข้อเสนอ |
| **C15 ผู้เชี่ยวชาญระบบสนับสนุนการตัดสินใจ** | EN-001-227; EN-001-126 | EN-131-203; EN-131-204 | EN-132-201; EN-132-202 | EN-135-319 Advanced OR; EN-135-336 | Forecast, scenario, simulation/optimization และ decision interface |
| **C22 วิศวกรโครงการและติดตั้งระบบอัจฉริยะ** | EN-001-227; EN-001-122; Workshop ตามโดเมน | EN-131-101; EN-131-207 | EN-132-201; EN-132-305 | EN-135-346 และวิชาเลือกโดเมน | EN-134-302/404 + EN-135-402 พร้อมแผนโครงการ ความเสี่ยง UAT และส่งมอบ |
| **C23 วิศวกรบูรณาการระบบอัจฉริยะ** | EN-001-122; EN-001-125; EN-001-230 | EN-131-205; EN-131-207; EN-131-208 | EN-132-305; EN-132-201 และ Core Track โดเมน | EN-135-338 และวิชาเลือก integration ของโดเมน | ระบบ data–device–control–API–AI พร้อม integration/acceptance test |
| **C24 ที่ปรึกษาโซลูชัน AI และการเปลี่ยนผ่านสู่ดิจิทัล** | EN-001-227; EN-001-122 | EN-131-101; EN-131-204 | EN-132-201; EN-132-202; EN-132-305 | EN-135-345; EN-135-347 | Current-state/gap analysis, roadmap, business case และ solution proposal |
| **C25 นักวิเคราะห์ธุรกิจอัจฉริยะและการตัดสินใจ** | EN-001-227; EN-001-126; EN-001-122 | EN-131-203; EN-131-204 | EN-132-202 Decision/Supply Chain | EN-135-319 Advanced OR; EN-135-336 Advanced Data Engineering | KPI model, semantic data, forecast/optimization และ executive recommendation |
