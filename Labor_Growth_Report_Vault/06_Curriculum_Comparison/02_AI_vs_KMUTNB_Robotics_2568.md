...
| 2 | เพิ่ม ROS 2, coordinate frame และ sensor/actuator integration | `EN-132-206 ระบบอัตโนมัติและหุ่นยนต์` | mobile/industrial robot demo ที่ส่งข้อมูลและคำสั่งผ่าน ROS 2 |
| 3 | เพิ่ม latency, profiling และ edge deployment | `EN-131-201`, `EN-131-206` | deploy model บน edge พร้อมวัด latency/power/resource |
| 4 | เพิ่ม MLOps สำหรับ cyber-physical system | `EN-131-205`, `EN-132-208` | versioned model + rollback + monitoring + digital thread |
