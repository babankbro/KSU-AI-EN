...
| 2 | เพิ่ม ROS 2, coordinate frame และ sensor/actuator integration | `EN-714-12012 ระบบอัตโนมัติและหุ่นยนต์` | mobile/industrial robot demo ที่ส่งข้อมูลและคำสั่งผ่าน ROS 2 |
| 3 | เพิ่ม latency, profiling และ edge deployment | `EN-714-12005`, `EN-714-12008` | deploy model บน edge พร้อมวัด latency/power/resource |
| 4 | เพิ่ม MLOps สำหรับ cyber-physical system | `EN-714-12007`, `EN-714-12012` | versioned model + rollback + monitoring + digital thread |
...
| 7 | ทบทวนขนาด Capstone | `EN-714-12018/404` | workload สอดคล้องจำนวนหน่วยกิต หรือแยก Capstone I–II |
