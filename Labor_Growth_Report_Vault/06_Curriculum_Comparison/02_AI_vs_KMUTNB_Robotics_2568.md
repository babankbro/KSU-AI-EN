...
| 2 | เพิ่ม ROS 2, coordinate frame และ sensor/actuator integration | `EN-132-106 ระบบอัตโนมัติและหุ่นยนต์` | mobile/industrial robot demo ที่ส่งข้อมูลและคำสั่งผ่าน ROS 2 |
| 3 | เพิ่ม latency, profiling และ edge deployment | `EN-131-104`, `EN-131-108` | deploy model บน edge พร้อมวัด latency/power/resource |
| 4 | เพิ่ม MLOps สำหรับ cyber-physical system | `EN-131-105`, `EN-132-105` | versioned model + rollback + monitoring + digital thread |
...
| 7 | ทบทวนขนาด Capstone | `EN-134-103/104` | workload สอดคล้องจำนวนหน่วยกิต หรือแยก Capstone I–II |
