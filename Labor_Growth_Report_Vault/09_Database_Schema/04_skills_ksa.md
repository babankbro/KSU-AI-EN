# ทักษะ ชุดทักษะ และ KSA

> ชั้นทักษะจากหลักฐานตลาดแรงงาน (HS/SS/EF) ชั้นที่ประเมินได้ (K/S/A) และการเชื่อมลงรายวิชา
>
> **13 ตาราง · 4296 แถว** — ส่งออกเป็น `04_skills_ksa.xlsx` หนึ่งตารางต่อหนึ่งชีต
>
...
หน่วยที่ประเมินได้จริง K1–K26 · S1–S20 · A1–A8
...
|---|---|:--:|---|
| `id` | text | ✓ |  |
| `dimension` | ksa_dimension | ✓ | K ความรู้ · S ทักษะ · A ทัศนคติ |
| `seq` | integer | ✓ |  |
| `name_th` | text | ✓ |  |
| `scope` | text |  |  |
| `covers` | text |  |  |
| `evidence` | text |  | หลักฐานที่ยอมรับได้ ใช้กับมิติทัศนคติ ห้ามให้คะแนนจากความประทับใจ |
| `target_depth` | depth_level |  | L1 เข้าใจ · L2 ประยุกต์ · L3 บูรณาการ · L4 นำไปใช้และประเมิน |
| `skill_kind` | text |  |  |
...
การจับคู่ KSA กับทักษะ HS/SS/EF ที่รองรับ
