...
> **หมายเหตุรหัส:** รหัส EN-132-211 ถึง EN-132-224 ในเอกสารนี้เป็นรหัสสมมติของทางเลือก 4+4 ที่ยังไม่ได้ใช้จริง และกำหนดขึ้น**ก่อน**หลักเลขตัวที่สามตามชั้นปี จึงไม่ปรากฏใน [[../04_Course_Descriptions_2570/11_Course_Index|ดัชนีรายวิชา]] และไม่ควรนำไปอ้างอิงในเล่มหลักสูตร ให้ใช้ EN-132-201 กับ EN-132-301–309 ตามแนวทางล่าสุดแทน  
...
**Decision Intelligence and Operations Analytics** — เสนอใช้ EN-132-306 (ปรับจาก AI for Production and Supply Chain)
...
**AI Software, Solution Architecture and Systems Integration** — เสนอใช้ EN-132-302 (ปรับจาก Software Development and AI Engineering)
...
**Generative and Agentic AI Systems** — เสนอใช้ EN-132-303 (ปรับจาก Agentic AI Systems)
...
| EN-132-306 | **ระบบอากาศยานไร้คนขับอัตโนมัติ การสำรวจระยะไกล และ GeoAI เพื่อการเกษตร** / *Autonomous UAV, Remote Sensing and GeoAI for Agriculture* | regulation/safety, RTK/GNSS mission planning, multispectral/thermal acquisition, GIS/raster, edge/spatial AI, fleet data integration และ change monitoring | H7, H8, H11, H16 | C03, C05, C12 |
