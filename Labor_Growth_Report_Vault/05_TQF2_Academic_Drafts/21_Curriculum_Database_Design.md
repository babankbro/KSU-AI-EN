...
`PLO1` `K1` `HS1` `AISK01` `EN-714-12002` เป็นรหัสที่นิ่ง มีความหมาย และถูกอ้างข้ามเอกสารอยู่แล้ว จึงใช้เป็น primary key ตรง ๆ ไม่สร้างเลขลำดับซ่อนไว้ให้ต้องแปลกลับไปมา — เวลาอ่านตารางเชื่อมจะเห็นความหมายทันทีโดยไม่ต้อง join
...
`study_plan_course` แยกตารางแทนการเก็บภาคเรียนไว้ใน `course` เพราะ `EN-714-12019` (แผน ก) กับ `EN-714-12020` (แผน ข) เป็นทางเลือกแทนกัน
