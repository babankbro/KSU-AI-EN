...
|---|---|:--:|
| GE-001-13002/002 ภาษาอังกฤษ | CLO (สื่อสารพื้นฐาน) | I |
...
|---|---|:--:|
| GE-001-13005 คุณค่ามหาวิทยาลัย · GE-001-13001 ดิจิทัล | CLO (จริยธรรม/พลเมืองดิจิทัล) | I |
...
| GE-002-14011 ผู้นำศตวรรษที่ 21 | CLO1, CLO2 | R |
...
|---|---|:--:|
| GE-001-13004 สุขภาพและการจัดการตนเอง · GE-001-13003 ธุรกิจดิจิทัล | CLO (วางแผนตนเอง/ผู้ประกอบการ) | I → R |
...
| --------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------- |
| **G1**    | แกนวิศวกรรม AI<br>*(AI Core Engineering)*                              | สอน/ฝึกโมเดลให้เรียนรู้และตัดสินใจ ("AI Teaching") + ซอฟต์แวร์/MLOps + ข้อมูล                 | **AISK01**                              |
| **G2**    | วิศวกรรมโดเมนอัจฉริยะ<br>*(Smart Domain Engineering)*                  | สร้าง/ประกอบโครงสร้างพื้นฐานกายภาพ · กลไก/เครื่องจักร · ระบบอัตโนมัติ ตามโดเมน                | **AISK02 (เกษตร), AISK03 (อุตสาหกรรม)** |
| **G3**    | การตรวจวัดและตัดสินใจอัจฉริยะ<br>*(Sensing & Decision Intelligence)*   | IoT/Edge/CPS · การรับรู้/มองเห็น · การพยากรณ์ · ระบบสนับสนุนการตัดสินใจ                       | **AISK04, AISK05**                      |
| **G4**    | AI เชิงสร้างและเอเจนต์<br>*(Generative & Agentic AI)*                  | GenAI/LLM/Agentic · การใช้เครื่องมือ AI อย่างตรวจสอบได้ · นวัตกรรมอุบัติใหม่                  | **AISK06**                              |
| **G5**    | AI ที่รับผิดชอบและมั่นคงปลอดภัย<br>*(Responsible & Secure AI)*         | จริยธรรม ความมั่นคงปลอดภัย มาตรฐาน หลักฐานธรรมาภิบาล และการรับรองระบบ                         | **AISK07**                              |
| **G6**    | การทำงานร่วมกันและผู้ประกอบการ<br>*(Collaboration & Entrepreneurship)* | การคิดวิเคราะห์ การสื่อสาร ทีม ภาวะผู้นำ การเรียนรู้ และผู้ประกอบการ                          | **AISK08**                              |
| **G7**    | สถาปัตยกรรมและการส่งมอบระบบ<br>*(Architecture & System Delivery)*      | Requirements, architecture, integration, quality, change, acceptance และ operational handover | **AISK09**                              |
...
**กลุ่ม:** **G1 · แกนวิศวกรรม AI (AI Core Engineering)** · **ประเภท:** Hard Skill · **ผูกทักษะแกน:** H1, H2, H3, H4 (+H12, H14) · **เทียบเคียง:** ACM/IEEE-CS/AAAI **CS2023** · NUS 3 เสาหลัก · AI Singapore **AIAP** (Software+Data เป็นฐานบังคับ)
...
**กลุ่ม:** **G2 · วิศวกรรมโดเมนอัจฉริยะ (Smart Domain Engineering)** · **ประเภท:** Hard Skill · **ผูกทักษะแกน:** H9, H15, **H16**, ฐานวิศวกรรมกายภาพ *(แกนของ **T1**)*
...
**กลุ่ม:** **G2 · วิศวกรรมโดเมนอัจฉริยะ (Smart Domain Engineering)** · **ประเภท:** Hard Skill · **ผูกทักษะแกน:** H5, H11, H13, **H17, H18** *(แกนของ **T2**)*
...
**กลุ่ม:** **G3 · การตรวจวัดและตัดสินใจอัจฉริยะ (Sensing & Decision Intelligence)** · **ประเภท:** Hard Skill · **ผูกทักษะแกน:** H9, H5 *(บูรณาการ)*, H4 *(Edge–Cloud)* *(แกนร่วมของ **T1 + T2**)*
...
**กลุ่ม:** **G3 · การตรวจวัดและตัดสินใจอัจฉริยะ (Sensing & Decision Intelligence)** · **ประเภท:** Hard Skill · **ผูกทักษะแกน:** H8, H11, H13, H16–H19 *(ครอบคลุม **T1 + T2 + T3**)*
...
**กลุ่ม:** **G4 · AI เชิงสร้างและเอเจนต์ (Generative & Agentic AI)** · **ประเภท:** Hard + Hybrid Skill · **ผูกทักษะแกน:** H6, H10, S7 *(แกนของ T3 และใช้ร่วมทุก Track)* · **เทียบเคียง:** IMDA GenAI TSC#2–#6, #9
...
**กลุ่ม:** **G5 · AI ที่รับผิดชอบและมั่นคงปลอดภัย (Responsible & Secure AI)** · **ประเภท:** Hybrid *(ความรู้ + ทักษะ + ทัศนคติ)* · **ผูกทักษะแกน:** H7 · **เทียบเคียง:** AI Verify (11 หลักการ) · IMDA GenAI TSC#8, #9 · **ISO/IEC 42001 · NIST AI RMF · EU AI Act** · ACM/IEEE/IFIP/ABET Cybersecurity
...
**กลุ่ม:** **G6 · การทำงานร่วมกันและผู้ประกอบการ (Collaboration & Entrepreneurship)** · **ประเภท:** Soft Skill · **ผูกทักษะแกน:** S1–S6, S8
...
**กลุ่ม:** **G7 · สถาปัตยกรรมและการส่งมอบระบบ (Architecture & System Delivery)** · **ประเภท:** Hard + Hybrid Skill · **ผูกทักษะ:** H20, S9, S10 *(เน้น T3 และใช้ข้าม Track)* · **หลักฐานตลาด:** C02, C06, C07, C11
