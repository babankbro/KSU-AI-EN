...
ข้อมูลสำรวจเดิมรายงานผู้ตอบเป็น **4 กลุ่มรวม จำนวน 55 ราย** เนื่องจากรวมบทบาทหลายประเภทไว้ในตัวเลือกเดียว เอกสารฉบับนี้จึงแยกบทบาทที่ปรากฏอยู่แล้วออกเป็น **8 กลุ่มวิเคราะห์** เพื่อให้การรับฟังเสียง การระบุความคาดหวัง และการสอบย้อนกลับ Needs → GA → PLO ชัดเจนขึ้น พร้อมกำหนด **กรอบจำนวนเป้าหมายสำหรับการสำรวจรอบขยาย 355 ราย** แยกจากจำนวนผู้ตอบจริงรอบเดิมอย่างชัดเจน
...
### กรอบจำนวนเป้าหมายสำหรับการสำรวจรอบขยาย 355 ราย

เนื่องจากหลักฐานเดิมไม่มีจำนวนแยก SH1–SH8 จึงกำหนดจำนวนต่อไปนี้เป็น **โควตาเป้าหมาย (target quota)** ไม่ใช่จำนวนผู้ตอบจริง โดยรักษาสัดส่วนกลุ่มรวมเดิมโดยประมาณ และเพิ่มน้ำหนักให้กลุ่มที่ให้หลักฐานโดยตรงต่อสมรรถนะ การจ้างงาน และประสบการณ์ผู้เรียน เมื่อเก็บข้อมูลจริงแล้วต้องแทนที่คอลัมน์นี้ด้วยจำนวนผู้ตอบจริงและรายงานอัตราการตอบกลับ

| รหัส | กลุ่มผู้มีส่วนได้ส่วนเสีย | จำนวนเป้าหมาย (คน) | ร้อยละของ 355 | เหตุผลกำหนดโควตา |
|---|---|---:|---:|---|
| **SH1** | นายจ้าง ผู้ประกอบการ สถานประกอบการ และผู้ใช้บัณฑิต | **39** | 10.99% | กลุ่มหลักสำหรับยืนยันสมรรถนะ อาชีพ และความพร้อมทำงาน โดยควบคุมจำนวนไม่เกิน 40 ราย |
| **SH2** | ผู้เชี่ยวชาญอุตสาหกรรมและนักวิชาชีพ | **19** | 5.35% | ทวนสอบเทคโนโลยี มาตรฐาน และความลึกเฉพาะแขนง โดยควบคุมจำนวนไม่เกิน 20 ราย |
| **SH3** | นักศึกษาปัจจุบัน | **105** | 29.58% | เป็นกลุ่มผู้รับผลโดยตรง ใช้ประเมินประสบการณ์เรียน ภาระการเรียน และการบรรลุผลลัพธ์ |
| **SH4** | ศิษย์เก่า | **29** | 8.17% | ตรวจช่องว่างระหว่างหลักสูตรกับงานจริงและความก้าวหน้าอาชีพ โดยควบคุมจำนวนไม่เกิน 30 ราย |
| **SH5** | นักเรียนมัธยมศึกษาตอนปลายและผู้เรียนในอนาคต | **112** | 31.55% | ตรวจความเข้าใจหลักสูตร ความสนใจ ความต้องการศึกษา และการเข้าถึงโอกาส |
| **SH6** | ผู้ปกครอง | **37** | 10.42% | รับฟังด้านค่าใช้จ่าย ความปลอดภัย ความเชื่อมั่น และโอกาสทำงานในพื้นที่ |
| **SH7** | คณาจารย์และผู้บริหารหลักสูตร | **9** | 2.54% | ยืนยันความเป็นไปได้ด้านการสอน ทรัพยากร และการประเมิน OBE โดยควบคุมจำนวนไม่เกิน 10 ราย |
| **SH8** | ผู้ทรงคุณวุฒิทางวิชาการและผู้ประเมินภายนอก | **5** | 1.41% | ทวนสอบมาตรฐาน คุณภาพ และความสอดคล้องจากภายนอก โดยควบคุมจำนวนไม่เกิน 6 ราย |
|  | **รวม** | **355** | **100.0%** |  |

> [!note] หลักการจัดสรร
> กำหนดเพดาน **SH1 ไม่เกิน 40 ราย, SH2 ไม่เกิน 20 ราย, SH4 ไม่เกิน 30 ราย, SH7 ไม่เกิน 10 ราย และ SH8 ไม่เกิน 6 ราย** โดยหลีกเลี่ยงตัวเลขกลมหลักสิบ แล้วกระจายโควตาที่เหลือไปยัง SH3, SH5 และ SH6 ซึ่งเป็นกลุ่มผู้รับผลโดยตรงและมีประชากรฐานกว้างกว่า แบบสอบถามรอบใหม่ต้องบังคับเลือกบทบาทหลักเพียงหนึ่งกลุ่มเพื่อป้องกันการนับซ้ำ
